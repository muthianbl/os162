...
void main() {
   ...
   printf("ptrptr0: ppt=%c, pts=%p, val=%p, address = %p\n", 
      **ptrptr0, *ptrptr0, ptrptr0, &ptrptr0);
   printf("ptrptr1: ppt=%c, pts=%p, val=%p, address = %p\n", 
      **ptrptr1, *ptrptr1, ptrptr1, &ptrptr1);
   printf("ptrptr2: ppt=%c, pts=%p, val=%p, address = %p\n", 
      **ptrptr2, *ptrptr2, ptrptr2, &ptrptr2);
   printf("ptrptr3: ppt=%c, pts=%p, val=%p, address =%p\n", 
